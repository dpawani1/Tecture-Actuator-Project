        ...
        while True:
            ...
            if palm_in is not None:
                ...
                for idx in mask_to_indices(mask, N_CELLS):
                    rr = idx // GRID_C
                    cc = idx % GRID_C
                    highlight_cell(frame, rr, cc, GRID_R, GRID_C)
            ...
            cv2.putText(frame, f"Mask:{stable_mask}  Cells:{mask_to_indices(stable_mask, N_CELLS)}",
                        (10, 25), cv2.FONT_HERSHEY_TRIPLEX, 0.6, 255)
