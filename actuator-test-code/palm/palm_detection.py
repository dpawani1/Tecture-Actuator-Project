...
class PalmDetection:
    def decode(self, frame, nn_data):
        ...
        raw_box_tensor = results.get("regressors").reshape(-1, 896, 18)
        raw_score_tensor = results.get("classificators").reshape(-1, 896, 1)
    ...
    def raw_to_detections(self, raw_box_tensor, raw_score_tensor, anchors, shape, num_keypoints):
        detection_boxes = self.decode_boxes(raw_box_tensor, anchors, shape, num_keypoints)
